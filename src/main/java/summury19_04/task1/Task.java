...
/**
 * Создайте программу для тестирования.
 * Вопросы и варианты ответов придумайте сами. Пользователь вводит количество вопросов,
 * на которые хочет ответить. Вопросы выбираются случайным образом из списка
 * . Варианты ответа выводятся в случайном порядке.
 * Программа подсчитывает количество правильных вариантов ответа и процент выполнения.
 */
public class Task {
